...
class GridViewCard extends StatelessWidget {
  ...
  const GridViewCard({super.key, required this.topProduct});
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Số lượng bán ra: ${topProduct.totalQuantity}",
                  style: kFontSubTitle(fontSize: 14), maxLines: 2, softWrap: true,
                )
              ],
            ),
          ),
